...
```
# Шаг 4: Создадим таблицы в БД
Создадим таблицы по умолчанию, выполнив команду миграции:
```
php artisan migrate
```
# Что дальше?
Во [второй части](02.md) мы интегрируем в наш проект шаблон администратора.
