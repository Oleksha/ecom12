...
53. [Управление баннерами на главной странице. Часть 1 | Создание данных миграции, посева и фиктивных баннеров](/documentation/53.md).
54. [Управление баннерами на главной странице. Часть 2 | Показывать баннеры с активным/неактивным переключением и удалением](/documentation/54.md).
55. [Управление баннерами на главной странице. Часть 3 | Добавление/редактирование баннера с проверкой и загрузкой изображения](/documentation/55.md).
56. [Управление баннерами на главной странице. Часть 4 | Динамическое отображение баннеров на главной странице](/documentation/56.md).
57. [Отображать избранные и новые товары на главной странице](/documentation/57.md).
58. [Динамическое отображение изображений и логотипов категорий на главной странице](/documentation/58.md).
59. [Список продуктов. Часть 1 | Список продуктов по категориям](/documentation/59.md).
60. [Список продуктов. Часть 2 | Хлебные крошки и навигация по категориям](/documentation/60.md).
